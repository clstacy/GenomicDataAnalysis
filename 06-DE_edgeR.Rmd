...
```{r ready-packages-edgeR, cache=FALSE}
...
```{r load-count_subset-edgeR, error=TRUE}
...
```{r identify-sampleOrder-edgeR}
str_split_fixed(counts |> colnames(), "\\.", n = 2)[, 1] |> cat()
```

```{r generate-metadata-edgeR}
...
```{r plotMDS-edgeR, fig.show="hold", out.width="25%"}
