...
```{r ready-packages-vizDE, results="hide",message=FALSE,cache=FALSE}
...
```{r load-libraries-vizDE}
library(org.Sc.sgd.db)
```

```{r compare-DEworkflows-vizDE}
...
```{r plot-MA-vizDE, fig.show="hold", out.width="33.3%"}
...
```{r plot-volcano-vizDE, fig.show="hold", out.width="33.3%"}
...
decideTests_all_edgeR <-
  read.delim(
    'https://github.com/clstacy/GenomicDataAnalysis_Fa23/raw/main/analysis/yeast_decideTests_allContrasts_edgeR.tsv',
    sep = "\t",
    header = T,
    row.names = 1
...
```{r venn-allContrasts-vizDE, fig.height=8, fig.width=10}
...
```{r create-your-own-Venn-vizDE, fig.height=4, fig.width=12}
